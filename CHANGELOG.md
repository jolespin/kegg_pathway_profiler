# Daily Log: 
* [2026.7.16] - Added `profile_pathway_coverage` to `kegg_pathway_profiler.pathways` for multi-genome parallel pathway coverage profiling (importable by downstream packages). Refactored `bin/profile-pathway-coverage.py` to use it.
